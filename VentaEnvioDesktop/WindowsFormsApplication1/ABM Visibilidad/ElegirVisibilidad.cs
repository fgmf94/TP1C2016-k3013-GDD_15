    ...
    public partial class ElegirVisibilidad : Form
    {
        ...
        private void buttonGuardar_Click(object sender, EventArgs e)
        {
            if (formato == "Eliminar Visibilidad")
            {
                ...
                {
                    MessageBox.Show("No se puede eliminar una visibilidad con publicaciones activas o pausadas", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
            ...
            else if (formato == "Modificar Visibilidad")
            {
                ...
                if (Convert.ToInt16(cant) != 0)
                {
                    MessageBox.Show("No se puede modificar una visibilidad con publicaciones activas o pausadas", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
